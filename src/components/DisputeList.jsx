              ...
              <div className="grid grid-cols-2 gap-4 text-sm">
                <div>
                  ...
                  <p className="font-mono">
                    {trimAddress(dispute?.buyer_renter)}
                  </p>
                </div>
                <div>
                  <p className="text-[var(--color-muted-foreground)]">Seller</p>
                  <p className="font-mono">
                    {trimAddress(dispute?.seller_landlord)}
                  </p>
                </div>
              </div>
              ...
              {dispute.resolved ? (
                ...
                <>
                  <button
                    ...
                    onClick={() =>
                      handleRefund(dispute?.escrow_id, dispute?.property_id)
                    }
                    className="px-4 py-2 rounded-md bg-[var(--color-destructive)] text-[var(--color-destructive-foreground)] font-medium hover:opacity-90 transition-all"
                  >
                    Refund Payer (Buyer)
                  </button>
                  <button
                    disabled={dispute?.resolved}
                    onClick={() =>
                      handleRelease(dispute?.escrow_id, dispute?.property_id)
                    }
                    className="px-4 py-2 rounded-md bg-[var(--color-primary)] text-[var(--color-primary-foreground)] font-medium hover:opacity-90 transition-all"
                  >
